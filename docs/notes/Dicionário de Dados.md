...
1. **Features de Modelos** (5 implementadas + futuras) - Análise de sentimento, embeddings, tópicos
...
| `tipo_mensagem` | category | Tipo específico (text\_pure, audio\_omitted, video\_attached, etc.) |
...
## Tipos de Mensagem (tipo\_mensagem)
...
## Grupos de Mensagem (grupo\_mensagem)
