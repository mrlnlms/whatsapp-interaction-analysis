...
- **Embeddings:** `message_embeddings_minilm.npy` (~101 MB)
...
**Pontos Fortes:**
- ✅ **3.7x mais rápido** - 842 msg/s vs 227 msg/s (MPNet)
- ✅ **Metade do tamanho** - 101 MB vs 201 MB
- ✅ **Qualidade excelente** - ~95% da qualidade do MPNet
- ✅ **Ideal para produção** - Melhor custo-benefício

**Trade-offs:**
- ⚠️ **384 dimensões** vs 768 (MPNet) - Menos capacidade
- ⚠️ **Ligeiramente menos preciso** - ~3-5% em separação semântica
...
- Similaridade com anterior: ~0.56 (maior que MPNet!)
- Densidade local: ~0.13 (similar ao MPNet)
- Tempo de geração: ~3 minutos (68k mensagens, CPU)
- Silhouette Score: 0.040 (ligeiramente menor que MPNet)
:::
